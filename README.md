...
* Target language/environments:
  ...
  * Visual Studio 2019/2017/2015, dotnet SDK cli, MSBuild on net46/netstandard2.0 (NOT your project platform) and related IDEs.
...
## History
* 0.10.11:
  * Experimental supported for net40/net45 MSBuild platforms. (In VS2010-2013, but not tested)
