...
dotnet pack -p:PackageVersion=0.9.11 -p:Configuration=Release -p:Platform=AnyCPU --include-symbols -o artifacts CenterCLR.RelaxVersioner.Tasks\CenterCLR.RelaxVersioner.Tasks.csproj
