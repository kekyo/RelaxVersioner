...
dotnet pack -p:PackageVersion=0.9.19 -p:Configuration=Release -p:Platform=AnyCPU -o artifacts CenterCLR.RelaxVersioner.Tasks\CenterCLR.RelaxVersioner.Tasks.csproj
